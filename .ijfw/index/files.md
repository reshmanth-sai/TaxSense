...
Generated: 2026-08-21T02:47:29Z
Root: .
...
- `./src/components/dashboard/DashboardCommandCenter.tsx` (719 lines, .tsx) -- import React, { useState } from 'react';
...
- `./src/components/HeroSection.tsx` (603 lines, .tsx) -- import React, { useState, useEffect, useRef, useMemo } from 'react';
...
- `./src/store/useTaxStore.ts` (657 lines, .ts) -- import { create } from 'zustand';
