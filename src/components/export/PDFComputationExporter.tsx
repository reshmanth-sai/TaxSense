...
---------------------------------------
Taxpayer Name: ${activeProfile?.name || 'Not provided'}
PAN: ${incomeProfile.pan || activeProfile?.pan || 'Not provided'}
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-slate-50 dark:bg-slate-900/60 rounded-2xl border border-slate-200/60 dark:border-white/[0.04] text-xs font-mono">
            <div>
              ...
              <strong className="text-slate-900 dark:text-white font-semibold">{activeProfile?.name || <span className="text-slate-400 font-normal italic">Not provided</span>}</strong>
            </div>
            <div>
              <span className="text-[10px] text-slate-400 uppercase tracking-widest block font-sans font-bold">PAN Number</span>
              <strong className="text-slate-900 dark:text-white font-semibold">{incomeProfile.pan || activeProfile?.pan || <span className="text-slate-400 font-normal italic">Not provided</span>}</strong>
            </div>
            <div>
          ...
          <div className="flex items-center justify-between text-[10px] text-slate-400 border-t border-slate-200 dark:border-white/[0.06] pt-3">
            <div className="flex items-center gap-1.5 font-mono">
              ...
              <span>Self-computed worksheet • AY 2026-27 rules • Not a filed return</span>
            </div>
