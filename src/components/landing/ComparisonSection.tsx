  ...
  return (
    <section className="py-24 md:py-28 px-6 max-w-5xl mx-auto space-y-16">
      ...
      <div className="space-y-2">
        <div className="grid grid-cols-3 gap-4 p-4 bg-white/60 dark:bg-[#0E131B]/70 border border-slate-200/80 dark:border-white/[0.06] rounded-2xl text-center backdrop-blur-md shadow-sm">
          <div className="space-y-1">
            <span className="text-2xs font-mono uppercase text-slate-500 dark:text-slate-400 font-semibold block">Time Required</span>
          ...
          <div className="space-y-1 border-x border-slate-200 dark:border-white/[0.06]">
            <span className="text-2xs font-mono uppercase text-slate-500 dark:text-slate-400 font-semibold block">Regime Analysis</span>
            <div className="text-xs sm:text-base font-bold text-slate-900 dark:text-white font-mono">
          ...
          <div className="space-y-1">
            <span className="text-2xs font-mono uppercase text-slate-500 dark:text-slate-400 font-semibold block">Example Savings*</span>
            <div className="text-xs sm:text-base font-bold text-slate-900 dark:text-white font-mono">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-500 text-center font-mono px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Traditional Card */}
        <CardSpotlight className="rounded-3xl" glowColor="rgba(239, 68, 68, 0.07)">
          <PremiumCard
            className="p-8 bg-slate-100/50 dark:bg-white/[0.015] border border-slate-200/80 dark:border-white/[0.04] space-y-6 text-left relative overflow-hidden group h-full"
        ...
        {/* TaxSense Card */}
        <CardSpotlight className="rounded-3xl" glowColor="rgba(16, 185, 129, 0.09)">
          <PremiumCard
            className="p-8 bg-white dark:bg-[#0E131B] border-2 border-emerald-500/40 dark:border-[#16E27A]/30 space-y-6 text-left shadow-xl shadow-emerald-500/5 relative overflow-hidden group h-full"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.6, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
          >
          <div className="absolute top-0 right-0 bg-emerald-500 text-white dark:bg-[#16E27A] dark:text-[#050607] px-3.5 py-1 text-2xs font-black uppercase tracking-wider rounded-bl-xl shadow-md">
            Recommended
          </div>
