      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none">
            Loved by Salaried Professionals
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
          {testimonialsData.map((test, index) => (
            <CardSpotlight key={index} className="rounded-3xl" glowColor="rgba(16, 185, 129, 0.08)">
              <PremiumCard
                className={`p-7 space-y-6 text-left flex flex-col justify-between ${test.offsetY} bg-white dark:bg-[#0E131B] border border-slate-200 dark:border-white/[0.06] rounded-3xl group relative overflow-hidden shadow-lg shadow-black/[0.02] dark:shadow-none hover:border-emerald-500/40 transition-all duration-300 h-full`}
